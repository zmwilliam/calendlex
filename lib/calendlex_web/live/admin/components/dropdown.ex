defmodule CalendlexWeb.Admin.Components.Dropdown do
  ...
  def main(assigns) do
    ~H"""
      <div 
        ...
        <div class="flex items-baseline cursor-pointer gap-x-1 dropdown-trigger"
  ...
  defp click_away(id) do
    JS.hide(to: content_selector(id), transition: "hidden", time: 0)
  end

  defp trigger_click(id) do
    JS.toggle(to: content_selector(id), in: "block", out: "hidden", time: 0)
  end

  defp content_selector(id) do
    "##{id} .dropdown-content"
  end
end
